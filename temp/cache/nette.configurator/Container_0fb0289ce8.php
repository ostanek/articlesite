<?php
// source: D:\xampp\htdocs\articlesite/config/common.neon
// source: D:\xampp\htdocs\articlesite/config/local.neon
// source: array
...
class Container_0fb0289ce8 extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	protected $wiring = [
		...
		'ArrayAccess' => [2 => ['05', 'application.1', 'application.3', 'application.4', 'application.5']],
		'Countable' => [2 => ['05']],
		'IteratorAggregate' => [2 => ['05']],
		'Traversable' => [2 => ['05']],
		'Nette\Application\Routers\RouteList' => [['05']],
		'App\Model\DatabaseManager' => [['06', '07']],
		'App\Model\ArticleManager' => [['06']],
		'App\Model\CategoryManager' => [['07']],
		'App\Presenters\BasePresenter' => [2 => ['application.1', 'application.3', 'application.4', 'application.5']],
		...
		'App\Presenters\Page2Presenter' => [2 => ['application.4']],
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'D:\xampp\htdocs\articlesite\app',
			'wwwDir' => 'D:\xampp\htdocs\articlesite\www',
			'vendorDir' => 'D:\xampp\htdocs\articlesite\vendor',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'D:\xampp\htdocs\articlesite/temp',
		];
	}
	...
	public function createService06(): App\Model\ArticleManager
	{
		return new App\Model\ArticleManager($this->getService('database.default.context'));
	}


	public function createService07(): App\Model\CategoryManager
	{
		return new App\Model\CategoryManager($this->getService('database.default.context'));
	}
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('06'), $this->getService('07'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('05'),
	...
	public function createServiceApplication__4(): App\Presenters\Page2Presenter
	{
		$service = new App\Presenters\Page2Presenter($this->getService('06'), $this->getService('07'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('05'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'D:\xampp\htdocs\articlesite/temp/cache/nette.application/touch'
		));
	...
	{
		return new Nette\Caching\Storages\SQLiteJournal('D:\xampp\htdocs\articlesite/temp/cache/journal.s3db');
	}


	public function createServiceCache__storage(): Nette\Caching\Storage
	{
		return new Nette\Caching\Storages\FileStorage('D:\xampp\htdocs\articlesite/temp/cache', $this->getService('cache.journal'));
	}


	public function createServiceContainer(): Container_0fb0289ce8
	{
		return $this;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=articlesite', 'root', null, ['lazy' => true]);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_0fb0289ce8 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('D:\xampp\htdocs\articlesite/temp/cache/latte');
