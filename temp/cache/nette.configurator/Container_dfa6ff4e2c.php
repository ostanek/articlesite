...
class Container_dfa6ff4e2c extends Nette\DI\Container
{
	protected $tags = [
		'nette.inject' => [
			'application.1' => true,
	...
	protected $wiring = [
		...
		'ArrayAccess' => [2 => ['05', 'application.1', 'application.3', 'application.4']],
		'Countable' => [2 => ['05']],
	...
	public function createServiceContainer(): Container_dfa6ff4e2c
	{
		return $this;
	}
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\LatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\LatteFactory {
			...
			public function __construct(Container_dfa6ff4e2c $container)
			{
